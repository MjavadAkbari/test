...
<div class="breadcrumb-box">
  ...
  <div class="container">
		  ...
		  <div class="span3 web-design">
			<a href="tb-health.html" class="work">
			  <img src="img/content/health.jpg" width="370" height="270" alt="">
			  <span class="shadow"></span>
			  <div class="bg-hover"></div>
			  <div class="work-title">
				<h3 class="title">(Health)سلامت</h3>
				<div class="description">نام دوره</div>
			  </div>
			</a>
		  </div>
		  
		   <div class="span3 web-design">
			<a href="tb-safety.html" class="work">
			  <img src="img/content/safety.jpg" width="370" height="270" alt="">
			  <span class="shadow"></span>
			  <div class="bg-hover"></div>
			  <div class="work-title">
				<h3 class="title">(Safety)ایمنی</h3>
				<div class="description">نام دوره</div>
			  </div>
			</a>
		  </div>
		   ...
		   <div class="span3 web-design">
			<a href="tb-enviroment.html" class="work">
			  <img src="img/content/enviro.jpg" width="370" height="270" alt="">
			  <span class="shadow"></span>
			  <div class="bg-hover"></div>
			  <div class="work-title">
				<h3 class="title">(Enviroment)محیط زیست</h3>
				<div class="description">نام دوره</div>
			  </div>
			</a>
		  </div>
