...
<section id="main">
  <header class="page-header">
    <div class="container">
      <h4 class="title">دوره های ویژه صنعت</h4>
    </div>	
  </header>
  <div class="container">
		  
		  <div class="span3 web-design">
			<a href="tb-energi.php" class="work">
			  <img src="img/content/energi.jpg" width="370" height="270" alt="">
			  <span class="shadow"></span>
			  <div class="bg-hover"></div>
			  <div class="work-title">
				<h3 class="title">مدیریت انرژی</h3>
				<div class="description">مدیریت انرژی الکتریکی در صنعت -ISO5001-EN16001</div>
			  </div>
			</a>
		  </div>
		  
		   <div class="span3 web-design">
			<a href="tb-brkh.php" class="work">
			  <img src="img/content/barghkh.jpg" width="370" height="270" alt="">
			  <span class="shadow"></span>
			  <div class="bg-hover"></div>
			  <div class="work-title">
				<h3 class="title">برق</h3>
				<div class="description">UPS- ABB- Areva- VAMMP- DigSilent,...</div>
			  </div>
			</a>
		  </div>
		  
		   <div class="span3 web-design">
			<a href="tb-mechkh.php" class="work">
			  <img src="img/content/pip.jpg" width="370" height="270" alt="">
			  <span class="shadow"></span>
			  <div class="bg-hover"></div>
			  <div class="work-title">
				<h3 class="title">مکانیک</h3>
				<div class="description">PDMS- PIPING- ABAQUS,....</div>
			  </div>
			</a>
		  </div>
