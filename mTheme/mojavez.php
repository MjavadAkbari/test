		  ...
		  <table class="table">
			...
			<tbody>
			  <tr bgcolor="#CCCCFF">
				<td>1</td>
				<td>ISO9001:2008</td>
				<td><a href="mojavez/iso.pdf">دانلود</a></td>
		      </tr>
			  <tr bgcolor="#CCCCCC">
				<td >2</td>
				<td>فعالیت مرکز آموزشی کوتاه مدت</td>
				<td><a href="mojavez/amoozesh.jpg">دانلود</a></td>
			  </tr>
			  <tr bgcolor="#CCCCFF">
				<td>3</td>
				<td>عضویت سندیکای برق ایران</td>
				<td><a href="mojavez/bargh.pdf">دانلود</a></td>
			  </tr>
			  <tr bgcolor="#CCCCCC">
				<td>4</td>
				<td>عضویت انجمن سازندگان تجهیرات صنعت نفت ایران</td>
				<td><a href="mojavez/naft.pdf">دانلود</a></td>
			  </tr>
			  <tr bgcolor="#CCCCFF">
				<td>5</td>
				<td>عضویت انجمن ریلی</td>
				<td ><a href="mojavez/rili.pdf">دانلود</a></td>
			  </tr>
			 <tr bgcolor="#CCCCCC">
				<td>6</td>
				<td>فعالیت صنعتی</td>
				<td><a href="mojavez/sanati.pdf">دانلود</a></td>
			  </tr>
			  <tr  bgcolor="#CCCCFF">
				<td>7</td>
				<td>عضویت سندیکای صنعت مخابرات ایران</td>
				<td><a href="mojavez/mokhaberat.pdf">دانلود</a></td>
			  </tr>
		  </table>
		</div>
