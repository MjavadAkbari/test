...
<div class="breadcrumb-box">
  <div class="container">
    <ul class="breadcrumb">
      <li class="active">دوره های آموزشی - کامپیوتر - عمومی</li>
    </ul>	
  </div>
</div><!-- .breadcrumb-box -->
		<div class="separate">
		  <table class="table">
			<thead>
			  ...
			  <tr bgcolor="#99CCCC">
				...
				<td>ICDL1</td>
				<td>60</td>
				<td><a href="sylabes/poblic/icdl1.pdf">دانلود</a></td>
			  ...
			  <tr bgcolor="#CCFFFF">
				...
				<td>ICDL2</td>
				<td>72</td>
				<td><a href="sylabes/poblic/icdl2.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#99CCCC">
				<td>3</td>
				<td>سخت افزار</td>
				<td>30</td>
				<td><a href="sylabes/poblic/hardware.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#CCFFFF">
				<td>4</td>
				<td>حسابداری1</td>
				<td>50</td>
				<td><a href="sylabes/poblic/hesabdari1.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#99CCCC">
				<td>5</td>
				<td>حسابداری2</td>
				<td>50</td>
				<td><a href="sylabes/poblic/hesabdari2.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
		  </table>
	</div>
