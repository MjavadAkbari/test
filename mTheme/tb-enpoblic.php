...
<div class="breadcrumb-box">
  <div class="container">
    <ul class="breadcrumb">
      <li class="active">نرم افزار - مهندسی - عمومی</li>
    </ul>	
  </div>
</div><!-- .breadcrumb-box -->
		<div class="separate">
		  <table class="table">
			<thead>
			  ...
			  <tr bgcolor="#99CCCC">
				<td>1</td>
				<td>AutoCAD مقدماتی</td>
				<td>30</td>
				<td><a href="sylabes/fani/autocad1.pdf">دانلود</a></td>
                <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
		    </tr>
			  <tr bgcolor="#CCFFFF">
				<td>2</td>
				<td>AutoCAD پیشرفته</td>
				<td>30</td>
				<td><a href="sylabes/fani/autocad2.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#99CCCC">
				<td>3</td>
				<td>Matlab</td>
				<td>30</td>
				<td><a href="sylabes/fani/matlab1.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
