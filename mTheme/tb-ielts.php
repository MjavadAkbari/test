...
<div class="breadcrumb-box">
  <div class="container">
    <ul class="breadcrumb">
      <li class="active">دوره های آموزشی  IELTS</li>
    </ul>	
  </div>
</div><!-- .breadcrumb-box -->
		<div class="separate">
		  <table class="table">
			<thead>
			  ...
			  <tr bgcolor="#99CCCC">
				...
				<td>IELTS4-5(1)</td>
				<td>30</td>
				<td><a href="download/ielts1.jpg">دانلود</a></td>
			  ...
			  <tr bgcolor="#99CCCC">
				...
				<td>IELTS5-6.5(1)</td>
				<td>30</td>
				<td><a href="download/ielts2.jpg">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#CCFFFF">
				<td>4</td>
			  ...
			  <tr bgcolor="#99CCCC">
				...
				<td>IELTS6.5-7(1)</td>
				<td>40</td>
				<td><a href="download/ielts3.jpg">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#CCFFFF">
				<td>6</td>
