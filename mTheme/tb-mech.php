...
<div class="breadcrumb-box">
  <div class="container">
    <ul class="breadcrumb">
      <li class="active">نرم افزار - مهندسی - مکانیک</li>
    </ul>	
  </div>
</div><!-- .breadcrumb-box -->
		<div class="separate">
		  <table class="table">
			<thead>
			  ...
			  <tr bgcolor="#99CCCC">
				<td>1</td>
				<td>Solid Works مقدماتی</td>
				<td>40</td>
				<td><a href="sylabes/fani/Soliworks1.pdf">دانلود</a></td>
                <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
		    </tr>
			  <tr bgcolor="#CCFFFF">
				<td>2</td>
				<td>Solid Works پیشرفته</td>
				<td>30</td>
				<td><a href="sylabes/fani/Soliworks2.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#99CCCC">
				<td>3</td>
				<td>Ansys</td>
				<td>30</td>
				<td><a href="sylabes/fani/ansys.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#CCFFFF">
				<td>4</td>
				<td>CATIA1</td>
				<td>50</td>
				<td><a href="sylabes/fani/catia1.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#99CCCC">
				<td>5</td>
				<td>CATIA2</td>
				<td>60</td>
				<td><a href="sylabes/fani/catia2.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#CCFFFF">
				<td>6</td>
				<td>ABAQUS</td>
				<td>40</td>
				<td><a href="sylabes/fani/Abaqus1.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#99CCCC">
				<td>7</td>
				<td>Mold Flow Insight</td>
				<td>32</td>
				<td><a href="sylabes/fani/MoldFlowInsight.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#CCFFFF">
				<td>8</td>
				<td>Gambit&Fluent</td>
				<td>30</td>
				<td><a href="sylabes/fani/fluent.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
