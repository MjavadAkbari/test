...
<div class="breadcrumb-box">
  <div class="container">
    <ul class="breadcrumb">
      <li class="active">نرم افزار - مهندسی - عمران</li>
    </ul>	
  </div>
</div><!-- .breadcrumb-box -->
		<div class="separate">
		  <table class="table">
			<thead>
			  ...
			  <tr bgcolor="#99CCCC">
				...
				<td>ETABS&Safe</td>
				<td>100</td>
				<td><a href="sylabes/fani/etabs.pdf">دانلود</a></td>
                <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
		    </tr>
			  <tr bgcolor="#CCFFFF">
				<td>2</td>
				<td>طراحی سازه براساس عملکرد به روش Push Over</td>
				<td>35</td>
				<td><a href="sylabes/fani/pushover.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#99CCCC">
				<td>3</td>
				<td>SAP</td>
				<td>40</td>
				<td><a href="sylabes/fani/sap.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#CCFFFF">
				<td>4</td>
				<td>اسکیس</td>
				<td>40</td>
				<td><a href="sylabes/fani/askis.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#99CCCC">
				<td>5</td>
				<td>GIS</td>
				<td>30</td>
				<td><a href="sylabes/fani/gis.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#CCFFFF">
				<td>6</td>
				<td>OpenSees</td>
				<td>30</td>
				<td><a href="sylabes/fani/OpenSees.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
