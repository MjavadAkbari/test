...
<div class="breadcrumb-box">
  <div class="container">
    <ul class="breadcrumb">
      <li class="active">دوره های آموزشی Per IELTS</li>
    </ul>	
  </div>
</div><!-- .breadcrumb-box -->
		<div class="separate">
		  <table class="table">
			<thead>
			  ...
			  <tr bgcolor="#99CCCC">
				...
				<td>Elementary1</td>
				<td>40</td>
				<td><a href="download/elementary.jpg">دانلود</a></td>
			  ...
			  <tr bgcolor="#CCFFFF">
				<td>4</td>
				<td>per Intermediate1</td>
				<td>40</td>
				<td><a href="download/pi.jpg">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#99CCCC">
				<td>5</td>
				<td>per Intermediate2</td>
				<td>40</td>
				<td><a href="download/pi.jpg">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  ...
			  <tr bgcolor="#99CCCC">
				...
				<td>Intermediate1</td>
				<td>40</td>
				<td><a href="download/Intermediate.jpg">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#CCFFFF">
				<td>8</td>
