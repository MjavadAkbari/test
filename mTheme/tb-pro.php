...
<div class="breadcrumb-box">
  <div class="container">
    <ul class="breadcrumb">
      <li class="active">نرم افزار - برنامه نویسی</li>
    </ul>	
  </div>
</div><!-- .breadcrumb-box -->
		<div class="separate">
		  <table class="table">
			<thead>
			  ...
			  <tr bgcolor="#99CCCC">
				<td>1</td>
				<td>برنامه نویسی C</td>
				<td>30</td>
				<td><a href="sylabes/programs/c.pdf">دانلود</a></td>
                <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
		    </tr>
			  <tr bgcolor="#CCFFFF">
				<td>2</td>
				<td>برنامه نویسی C++(OOP)</td>
				<td>30</td>
				<td><a href="sylabes/programs/oop.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#99CCCC">
				<td>3</td>
				<td>C#.NET(کنسول و ویندوز)</td>
				<td>45</td>
				<td><a href="sylabes/programs/csharp.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#CCFFFF">
				<td>4</td>
				<td>ASP.NET(C#)</td>
				<td>45</td>
				<td><a href="sylabes/programs/asp.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#99CCCC">
				<td>5</td>
				<td>C#2(LINQ)</td>
				<td>21</td>
				<td><a href="sylabes/programs/linq.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#CCFFFF">
				<td>6</td>
				<td>C#3(WPF)</td>
				<td>45</td>
				<td><a href="sylabes/programs/wpf.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#99CCCC">
				<td>7</td>
				<td>SQL Server</td>
				<td>45</td>
				<td><a href="sylabes/programs/sql.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#CCFFFF">
				<td>8</td>
				<td>Java 2 SE</td>
				<td>45</td>
				<td><a href="sylabes/programs/java.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#99CCCC">
				<td>9</td>
				<td>طراحی صفحات Web</td>
				<td>50</td>
				<td><a href="sylabes/programs/web.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#CCFFFF">
				<td>10</td>
				<td>PHP</td>
				<td>30</td>
				<td><a href="sylabes/programs/php.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#99CCCC">
				<td>11</td>
				<td>JavaScript</td>
				<td>30</td>
				<td><a href="sylabes/programs/Javascript.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
