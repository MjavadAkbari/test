...
<div class="breadcrumb-box">
  <div class="container">
    <ul class="breadcrumb">
      <li class="active">نرم افزار - مهندسی - صنایع</li>
    </ul>	
  </div>
</div><!-- .breadcrumb-box -->
		<div class="separate">
		  <table class="table">
			<thead>
			  ...
			  <tr bgcolor="#99CCCC">
				...
				<td>MS Project</td>
				<td>30</td>
				<td><a href="sylabes/fani/msp.pdf">دانلود</a></td>
			  ...
			  <tr bgcolor="#CCFFFF">
				...
				<td>Primavera</td>
				<td>30</td>
				<td><a href="sylabes/fani/primavera.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#99CCCC">
				<td>3</td>
				<td>Minitab</td>
				<td>24</td>
				<td><a href="sylabes/fani/minitab.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#CCFFFF">
				<td>4</td>
				<td>Comfar</td>
				<td>30</td>
				<td><a href="sylabes/fani/comfar.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
