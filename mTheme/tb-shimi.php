...
<div class="breadcrumb-box">
  <div class="container">
    <ul class="breadcrumb">
      <li class="active">نرم افزار - مهندسی - شیمی</li>
    </ul>	
  </div>
</div><!-- .breadcrumb-box -->
		<div class="separate">
		  <table class="table">
			<thead>
			  ...
			  <tr bgcolor="#99CCCC">
				...
				<td>Piping</td>
				<td>42</td>
				<td><a href="sylabes/fani/piping.pdf">دانلود</a></td>
			  ...
			  <tr bgcolor="#CCFFFF">
				...
				<td>PDMS</td>
				<td>30</td>
				<td><a href="sylabes/fani/pdms.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#99CCCC">
				<td>3</td>
				<td>Auto Plant</td>
				<td>20</td>
				<td><a href="sylabes/fani/autoplant.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#CCFFFF">
				<td>4</td>
				<td>PV Elite</td>
				<td>40</td>
				<td><a href="sylabes/fani/pvelite.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#99CCCC">
				<td>5</td>
				<td>تحلیل تنش و ساپورت گذاری خطوط لوله با نرم افزار CAESAR</td>
				<td>25</td>
				<td><a href="sylabes/fani/caesar.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#CCFFFF">
				<td>6</td>
				<td>Aspen Plus</td>
				<td>30</td>
				<td><a href="sylabes/fani/aspen.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
			  <tr bgcolor="#99CCCC">
				<td>7</td>
				<td>HYSYS</td>
				<td>30</td>
				<td><a href="sylabes/fani/hysys.pdf">دانلود</a></td>
                 <td><a href="http://91.98.155.84:8081/reg/RegClass.aspx">ثبت نام</a></td>
			  </tr>
