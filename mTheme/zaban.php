...
<div class="breadcrumb-box">
  <div class="container">
    <ul class="breadcrumb">
      <li class="active">زبان انگلیسی</li>
    </ul>	
  </div>
</div><!-- .breadcrumb-box -->
...
<section id="main">
  ...
  <div class="container">
		  ...
		  <div class="span3 web-design">
			<a href="tb-ielts.php" class="work">
			  <img src="img/content/ielts1.jpg" width="370" height="270" alt="">
		   ...
		   <div class="span3 web-design">
			<a href="tb-preielts.php" class="work">
			  <img src="img/content/preielts.jpg" width="370" height="270" alt="">
			  <span class="shadow"></span>
			  <div class="bg-hover"></div>
			  <div class="work-title">
